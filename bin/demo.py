...
if __name__ == '__main__':
    ...
    # example command 
    # python bin/demo.py -s partial_spread.py -l -1 -c configs/demo.yaml -g interactive --cam_range 1
    # python bin/demo.py -s simple_hunt.py -l -1 -c configs/demo.yaml -g hunt --cam_range 10 --share_viewer
